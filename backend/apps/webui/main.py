...
app.state.USE_SAML_ROLE_ASSIGNMENT = USE_SAML_ROLE_ASSIGNMENT
app.state.AUTH_TRUSTED_ROLE_HEADER = WEBUI_AUTH_TRUSTED_ROLE_HEADER
app.state.TRUSTED_ADMIN_ROLE_VALUE = TRUSTED_ADMIN_ROLE_VALUE
app.state.TRUSTED_USER_ROLE_VALUE = TRUSTED_USER_ROLE_VALUE
app.state.TRUSTED_PENDING_ROLE_VALUE = TRUSTED_PENDING_ROLE_VALUE
